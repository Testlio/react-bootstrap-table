...
<<<<<<< HEAD
        var searchTextInput = this.props.enableSearch ? React.createElement(
          "div",
          { className: "bs-table-search-container" },
          React.createElement("input", { type: "text", className: "form-control input-sm bs-table-search", placeholder: this.props.searchPlaceholder ? this.props.searchPlaceholder : "Search", onKeyUp: this.handleKeyUp.bind(this) })
        ) : null;
        var modal = this.props.enableInsert ? this.renderInsertRowModal(modalClassName) : null;
        var warningStyle = {
          display: "none",
